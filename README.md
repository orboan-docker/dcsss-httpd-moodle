# Added php 5.6.x and moodle 3.2 to:
# CentOS-7 with supervisord launcher, SSH server, shellinabox and httpd server | Docker

This is a CentOS-7 Docker with supervisor, SSH server, shellinabox, httpd server, php 5.6.x and the vle Moodle 3.2 web app.
...
docker run --name mysql -d -p 3306:3306 -e MYSQL_ROOT_PASSWORD=whatever -e MYSQL_DATABASE1=moodle -e MYSQL_USER1=vle_user -e MYSQL_PASSWORD1=iaw orboan/dcsss-mariadb
